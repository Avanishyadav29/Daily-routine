    ...
    <div className="max-w-3xl mx-auto pb-12 animate-fade-in">
      ...
      <div className="space-y-5">
        {loading ? (
          ...
          <div key={a.id} className="bg-white dark:bg-[#15171e] border border-slate-200 dark:border-slate-800/60 rounded-3xl p-5 sm:p-7 shadow-lg relative group">
            {canPost && (
            ...
            {a.text && <p className="text-slate-700 dark:text-slate-300 leading-relaxed whitespace-pre-wrap text-sm sm:text-base">{a.text}</p>}
